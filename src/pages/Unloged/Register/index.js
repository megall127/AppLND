...
import { BoxInfos, ButtonForget, ButtonForgetText, ImageBack, InputLogin, TextInputCheck, TittleSubText, TittleText, ViewBody, ViewBodyScroll } from "./styled";
...
const RegisterIndex = () => {
    ...
    useEffect(() => {
      setRegisterInfos(prevState => ({...prevState, email:email, name: nome}))
    },[email, nome])
    ...
    return(
            ...
            <BoxInfos>
                ...
                <TittleSubText>1 de 3</TittleSubText>
                ...
                <PrimaryButton marginTops={10} label="Ja tenho conta" onPress={()=> navigation.navigate("LOGINN")}/>
            </BoxInfos>
            </DropShadow>
        </ViewBody>
    )
